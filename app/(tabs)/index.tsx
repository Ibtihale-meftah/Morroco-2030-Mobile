      ...
      <View style={styles.section}>
        ...
        <View style={styles.bigCards}>
          <Animated.View entering={FadeInUp.delay(150).duration(500)}>
            <TouchableOpacity style={styles.bigCard} onPress={() => router.push("/login" as any)}>
          ...
          <Animated.View entering={FadeInUp.delay(250).duration(500)}>
            <TouchableOpacity style={styles.bigCard} onPress={() => router.push("/register" as any)}>
              <Text style={styles.bigCardIcon}>📖</Text>
              <Text style={styles.bigCardText}>Créer un compte</Text>
              <Text style={styles.bigCardArrow}>↗</Text>
            </TouchableOpacity>
          </Animated.View>
        </View>
